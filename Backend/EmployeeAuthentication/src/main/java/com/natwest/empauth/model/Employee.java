package com.natwest.empauth.model;
...
public class Employee {
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName + ", email="
				...
				+ ", dateOfBirth=" + dateOfBirth + ", phoneNo=" + phoneNo + ", address=" + address + ", empPassword="
				+ empPassword + ", AdpPortalAccess=" + AdpPortalAccess + ", OutlookAccess=" + OutlookAccess
				+ ", WorkdayAccess=" + WorkdayAccess + ", SharedDriveAccess=" + SharedDriveAccess
